# An app to help answer general farming questions, chat about farming, and help plan growing seasons.
# There will be a page for chat and a page for planning and growing seasons.
...
def init_chat_session_variables():
    ...
    session_vars = [
        'farmer_response','seed', 'farming_page',  'chat_messages', 'chat_choice','response', 'history', 'chat_history_dict', 'i'
    ]
    default_values = [
        '','Spooky', 'general_chat',  [], '', '', None, {}, 0
    ]
